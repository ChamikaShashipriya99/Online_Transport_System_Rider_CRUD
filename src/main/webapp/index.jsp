...
<head>
    ...
    <title>RideEase - Book Your Ride</title>
...
<body>
	...
	<main class="container mt-5">
	    <h1 class="text-center mb-4">Book Your Ride Here</h1>
	    <form action="insert" method="post" onsubmit="return validateForm()">
	        ...
	        <div class="mb-3">
	            ...
	            <input type="number" class="form-control" id="passengerCount" name="passengerCount" min="1" max="10" required>
