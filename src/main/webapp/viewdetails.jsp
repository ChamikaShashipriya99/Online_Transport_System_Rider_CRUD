...
<head>
    ...
    <title>RideEase - View Details</title>
...
<body>
    ...
    <main class="container mt-5">
            ...
            <tbody>
                <c:forEach var="booking" items="${listBookings}">
                    <tr>
                        ...
                        <td><c:out value="${booking.phoneNumber}" /></td>
                        <td><c:out value="${booking.vehicleType}" /></td>
                        <td><c:out value="${booking.passengerCount}" /></td>
                        <td>
                            <a href="edit?id=<c:out value='${booking.id}' />" class="btn btn-primary btn-sm">Edit</a>
                            <a href="delete?id=<c:out value='${booking.id}' />" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this booking?')">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <div class="text-center mt-3">
            <a href="new" class="btn btn-success">Book Another Ride</a>
        </div>
    </main>
